var TableData = function() {
	...
	var runDataTable_example2 = function() {
		...
		function editRow(oTable, nRow) {
			...
			jqTds[11].innerHTML = '<button type="button" onclick="delRow(this);" class="btn-save btn btn-xs save-row"><span class="fa fa-save"></span></button>' + '<br>' + '<button type="button" onclick="delRow(this);" class="btn-cancel btn btn-xs cancel-row"><span class="fa fa-close"></span></button>';
