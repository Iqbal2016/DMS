var TableData = function() {
	...
	var listItem = function() {
		...
		function editRow(oTable, nRow) {
			...
			jqTds[2].innerHTML = '<input type="text" class="form-control" value="' + aData[2] + '" readonly>';
			jqTds[3].innerHTML = '<input type="text" class="form-control quant" value="' + aData[3] + '">';
			jqTds[4].innerHTML = '<input type="text" class="form-control" value="' + aData[4] + '" readonly>';
