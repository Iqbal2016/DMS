var TableData = function() {
	...
	var listItem = function() {
		...
		function saveRow(oTable, nRow) {
			...
			oTable.fnUpdate('<button type="button" onclick="delRow(this);"class="btn-edit btn btn-xs edit-row"><span class="fa fa-edit"></span></button>' + '&nbsp' + '<button type="button" onclick="delRow(this);"class="btn-del btn btn-xs delete-row"><span class="fa fa-trash"></span></button>', nRow, 7, false);
			oTable.fnDraw();
			calTotal();
			newRow = false;
...
*/
	...
	function calTotal(){
	    var sum=0;
	    $('#listItem tbody tr td:nth-child(6)').each(function() {
	        var a=$(this).text();
	        var temp = parseInt(a);
	        sum=sum+temp;
	   ...
	   var ssum=0;
	    $('#listItem tbody tr td:nth-child(7)').each(function() {
	        var a=$(this).text();
	        var temp = parseInt(a);
	        ssum=ssum+temp;
	    
	   });
	   $("#total_sale_price").val(ssum);
