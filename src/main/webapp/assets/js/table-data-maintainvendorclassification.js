var TableData = function() {
	...
	var vendorClassification = function() {
		var newRow = false;
		...
		function editRow(oTable, nRow) {
			...
			jqTds[11].innerHTML = '&nbsp'+'<button type="button" class="save-row btn btn-xs"> <span class="fa fa-save"></span></button>' +'&nbsp;' + '<button type="button" class="cancel-row btn btn-xs "> <span class="fa fa-close"></span></button>';
		...
		function saveRow(oTable, nRow) {
			...
			oTable.fnUpdate('<button type="button" onclick="delRow(this);"class="btn-edit btn btn-xs edit-row"><span class="fa fa-edit"></span></button>' + '&nbsp' + '<button type="button" onclick="delRow(this);"class="btn btn-del btn-xs delete-row"><span class="fa fa-trash"></span></button>', nRow, 11, false);
			oTable.fnDraw();
			newRow = false;
		...
		$('#vendorClassification').on('click', '.cancel-row', function(e) {
		...
		$('#vendorClassification').on('click', '.delete-row', function(e) {
		...
		$('#vendorClassification').on('click', '.save-row', function(e) {
			e.preventDefault();
		...
		$('#vendorClassification').on('click', '.edit-row', function(e) {
		...
		var oTable = $('#vendorClassification').dataTable({
			"aoColumnDefs" : [{
				"aTargets" : [0]
			}],
			"oLanguage" : {
