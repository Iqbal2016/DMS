var TableData = function() {
	...
	var maintainMaterialClassification = function() {
		var newRow = false;
		...
		function editRow(oTable, nRow) {
			...
			jqTds[12].innerHTML = '&nbsp'+'<button type="button" class="save-row btn btn-xs"> <span class="fa fa-save"></span></button>' +'&nbsp;' + '<button type="button" class="cancel-row btn btn-xs "> <span class="fa fa-close"></span></button>';
		...
		function saveRow(oTable, nRow) {
			...
			oTable.fnUpdate('<button type="button" onclick="delRow(this);"class="btn-edit btn btn-xs edit-row"><span class="fa fa-edit"></span></button>' + '&nbsp' + '<button type="button" onclick="delRow(this);"class="btn btn-del btn-xs delete-row"><span class="fa fa-trash"></span></button>', nRow, 12, false);
			oTable.fnDraw();
			newRow = false;
		...
		$('#maintainMaterialClassification').on('click', '.cancel-row', function(e) {
		...
		$('#maintainMaterialClassification').on('click', '.delete-row', function(e) {
		...
		$('#maintainMaterialClassification').on('click', '.save-row', function(e) {
			e.preventDefault();
		...
		$('#maintainMaterialClassification').on('click', '.edit-row', function(e) {
		...
		var oTable = $('#maintainMaterialClassification').dataTable({
			"aoColumnDefs" : [{
				"aTargets" : [0]
			}],
			"oLanguage" : {
	...
	return {
		...
		init : function() {
			/*additionalSitesList();*/
			maintainMaterialClassification();
			/*maintainMaterialClassification_customer();
			bank_ac_table();
			mobileFinService();*/
