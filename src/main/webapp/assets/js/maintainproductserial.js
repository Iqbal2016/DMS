var TableData = function() {
	...
	var listItem = function() {
		...
		function editRow(oTable, nRow) {
			...
			jqTds[0].innerHTML = '<input type="text" class="form-control uppercase" value="' + aData[0] + '">';
			jqTds[1].innerHTML = '<input type="text" class="form-control" value="' + aData[1] + '">';
			/*		jqTds[2].innerHTML = '<input type="text" class="form-control" value="' + aData[2] + '">';
			jqTds[3].innerHTML = '<input type="text" class="form-control quant" value="' + aData[3] + '">';
			jqTds[4].innerHTML = '<input type="text" class="form-control" value="' + aData[4] + '">';
			jqTds[5].innerHTML = '<input type="text" class="form-control price" value="' + aData[5] + '">';
		...
		function saveRow(oTable, nRow) {
			...
			oTable.fnUpdate('<button type="button" onclick="delRow(this);"class="btn-edit btn btn-xs edit-row"><span class="fa fa-edit"></span></button>' + '&nbsp' + '<button type="button" onclick="delRow(this);"class="btn-del btn btn-xs delete-row"><span class="fa fa-trash"></span></button>', nRow, 2, false);
			oTable.fnDraw();
			calTotal();
			newRow = false;
