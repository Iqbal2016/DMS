...
var Dashboard = function() {
	...
	var sparklineHandler = function() {
		...
		$(".sparkline-new1 span").sparkline([500, 223, 702, 811, 1000, 902, 1287], {
			type: "bar",
			barColor: "#008080",
			barWidth: "5",
			height: "24",
		...
		$(".sparkline-new2 span").sparkline([200, 482, 801, 700, 1325, 1687, 623], {
			type: "bar",
			barColor: "#eea236",
			barWidth: "5",
			height: "24",
		...
		$(".sparkline-new3 span").sparkline([100, 682, 101, 400, 125, 1687, 223], {
			type: "bar",
			barColor: "#6495ed",
			barWidth: "5",
			height: "24",
