...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="subadmin/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">

    <!-- MetisMenu CSS -->
    <link href="subadmin/vendor/metisMenu/metisMenu.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="subadmin/dist/css/sb-admin-2.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="subadmin/vendor/morrisjs/morris.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="subadmin/vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">MASODA</a>
            </div>
            <!-- /.navbar-header -->
								...
								<a href="toc?type=suite&amp;currsuitecode=${ suite.getId() }" class="submenu">
									<div class="item-content">
										...
										<div class="item-inner">
											<%-- <span class="title">${ suite.getLabel() }</span><span class="fa arrow"></span> --%>
											<i class="title"></i> ${ suite.getLabel() }<span class="fa arrow"></span>
										</div>
									</div>
								</a>
								<ul class="sub-menu">
